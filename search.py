...
def depthFirstSearch(problem):
    ...
    visited = []                    #tao list de kiem tra state da duoc truy cap hay chua
    path=[]                         #tao list de luu tru cac ket qua duong di  
...
def breadthFirstSearch(problem):
    ...
    fringe = Queue()                        #tao Fringle de quan ly trang thai duoc mo rong
    fringe.push(problem.getStartState())
    visited = []                            #tao list de kiem tra state da duoc truy cap hay chua
    tempPath=[]                             #bien Temp de luu cac duong di nhat thoi
    path=[]                                 #tao list de luu tru cac ket qua duong di  
...
def uniformCostSearch(problem):
    ...
    fringe = PriorityQueue()                    #tao Fringle de quan ly trang thai duoc mo rong
